...
export const REGIONAL_COS_MARKER_PATH = 'ocupathif/regional-cos/v0.993.1.json';
export const REGIONAL_COS_MARKER_URL_PATH = '/ocupathif/regional-cos/v0.993.1.json';
